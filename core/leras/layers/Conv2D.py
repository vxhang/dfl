...
class Conv2D(nn.LayerBase):
    ...
    def build_weights(self):
        ...
        self.weight = tf.get_variable("weight", (self.kernel_size,self.kernel_size,int(self.in_ch),int(self.out_ch)), dtype=self.dtype, initializer=kernel_initializer, trainable=self.trainable )
